...
# python3 /cpfs01/nlp/leizhengxing/stock-rl/dataset_make_2_parallel_webshop.py
#!/bin/bash
# ─────────────────────────────────────────────────────────────────────────────
#  check_webshop_servers.sh
#  Verifies connectivity to all servers across all clusters.
#  Define clusters as: WEBSHOP_CLUSTER_<N>="host:base_port:num_servers"
# ─────────────────────────────────────────────────────────────────────────────

# ── Define your clusters here ────────────────────────────────────────────────
WEBSHOP_CLUSTER_0="10.248.101.37:9000:16"
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    +trainer.val_data_dir=val_log/webshop-35B-test-fuck-fuck \
