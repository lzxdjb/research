...
JOB_NAME=${JOB_NAME:-8_state_agreement_joint_grpo}
...
STATE_PREDICTIVE_RATIO_MODE=${STATE_PREDICTIVE_RATIO_MODE:-product}
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    actor_rollout_ref.actor.policy_loss.loss_mode=state_agreement_joint_grpo \
    ...
    +actor_rollout_ref.actor.policy_loss.state_predictive_objective=$STATE_PREDICTIVE_OBJECTIVE \
    +actor_rollout_ref.actor.policy_loss.state_predictive_agreement_score_mode=$STATE_PREDICTIVE_AGREEMENT_SCORE_MODE \
