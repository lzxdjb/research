...
export HDL_ENV_SH
export HDL_AGENT_MAX_ROUNDS=${HDL_AGENT_MAX_ROUNDS:-100}
export HDL_AGENT_MAX_ASSISTANT_TURNS=${HDL_AGENT_MAX_ASSISTANT_TURNS:-100}
export HDL_AGENT_MAX_USER_TURNS=${HDL_AGENT_MAX_USER_TURNS:-100}
...
export HDL_SIMULATE_TOOL_BONUS=${HDL_SIMULATE_TOOL_BONUS:-0.03}
export HDL_SYNTHESIZE_TOOL_BONUS=${HDL_SYNTHESIZE_TOOL_BONUS:-0.02}
export HDL_TOOL_BONUS_MIN_FINAL_SCORE=${HDL_TOOL_BONUS_MIN_FINAL_SCORE:-0.05}
export HDL_REWARD_CAP=${HDL_REWARD_CAP:-1.05}
...
python3 -m verl.trainer.main_ppo --config-path="$PROJECT_DIR/verl/trainer/config" \
    ...
    actor_rollout_ref.rollout.multi_turn.max_assistant_turns="$HDL_AGENT_MAX_ASSISTANT_TURNS" \
    actor_rollout_ref.rollout.multi_turn.max_user_turns="$HDL_AGENT_MAX_USER_TURNS" \
    actor_rollout_ref.rollout.multi_turn.max_tool_response_length="${MAX_TOOL_RESPONSE_LENGTH:-4096}" \
    ...
    actor_rollout_ref.rollout.multi_turn.hdl_simulate_tool_bonus="$HDL_SIMULATE_TOOL_BONUS" \
    actor_rollout_ref.rollout.multi_turn.hdl_synthesize_tool_bonus="$HDL_SYNTHESIZE_TOOL_BONUS" \
    actor_rollout_ref.rollout.multi_turn.hdl_tool_bonus_min_final_score="$HDL_TOOL_BONUS_MIN_FINAL_SCORE" \
    actor_rollout_ref.rollout.multi_turn.hdl_reward_cap="$HDL_REWARD_CAP" \
    ...
    trainer.nnodes=1 \
    trainer.val_before_train="${VALIDATE_BEFORE_TRAIN:-False}" \
