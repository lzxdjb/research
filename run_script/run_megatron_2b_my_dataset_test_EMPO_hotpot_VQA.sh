...
train_path=/cpfs01/nlp/leizhengxing/stock-rl/data/multimodal_vqa/vqa_mix_train.parquet
test_path=/cpfs01/nlp/leizhengxing/stock-rl/data/multimodal_vqa/vqa_mix_train.parquet
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    +data.multi_val_files.okvqa_val="/cpfs01/nlp/leizhengxing/stock-rl/data/multimodal_vqa/okvqa_val.parquet" \
    +data.multi_val_files.mmmu="/cpfs01/nlp/leizhengxing/stock-rl/data/multimodal_vqa/mmmu_test.parquet" \
    ...
    +trainer.val_data_dir=val_log/VQA-4B \
    +trainer.validate_before_train=True \
    +trainer.val_only=True \
    trainer.use_legacy_worker_impl=disable \
    actor_rollout_ref.rollout.multi_turn.format=qwen3_coder \
    +actor_rollout_ref.rollout.multi_turn.use_seeupo=True \
    actor_rollout_ref.actor.policy_loss.loss_mode=empo_new_clip_norm_dual_clip \
