...
# Quick-test server: start one OpenAI-compatible 4B server that can play frozen
...
TEACHER_MODEL_PATH="${TEACHER_MODEL_PATH:-${TEACHER_MODEL:-/mnt/data/HithinkOmniSSD/user_workspace/leizhengxing/stock_agent_loop/data/Qwen3.5-9B}}"
...
echo "Starting digital onboarding quick-test client/reward server"
...
============================================================
Digital onboarding quick-test server is ready.
