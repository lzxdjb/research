...
ETP=${ETP:-1}
GEN_TP=${GEN_TP:-4}
train_path=data/new_train/ood_dataset.parquet
test_path=data/new_train/ood_dataset.parquet
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    actor_rollout_ref.model.path=./data/model \
    ...
    +trainer.val_data_dir=val_log/fuck_test \
    ...
    actor_rollout_ref.rollout.multi_turn.format=tool_begin \
