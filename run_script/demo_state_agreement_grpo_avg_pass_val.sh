...
THSCC_TRAIN_CREATOR=${THSCC_TRAIN_CREATOR:-leizhengxing}
JOB_NAME=${JOB_NAME:-8_state_agreement_grpo_avg_pass_val}
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    actor_rollout_ref.model.path=/mnt/data/HithinkOmniSSD/user_workspace/leizhengxing/stock_agent_loop/data/Qwen3.5-4B \
    ...
    actor_rollout_ref.actor.policy_loss.loss_mode=state_agreement_grpo \
