...
# pkill -f "webshop_server" 2>/dev/null || true

cd /mnt/data/HithinkOmniSSD/user_workspace/leizhengxing/stock_agent_loop/stock-rl/webshop
source /mnt/data/HithinkOmniSSD/user_workspace/leizhengxing/stock_agent_loop/stock-rl/miniconda3/bin/activate
