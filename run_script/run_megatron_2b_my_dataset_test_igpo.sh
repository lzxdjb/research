...
export WANDB_DIR=/mnt/data/HithinkOmniSSD/user_workspace/leizhengxing/stock_agent_loop/wandb_logs/$JOB_NAME
# export env=fuji
export CUDA_VISIBLE_DEVICES=0,1
train_path=/cpfs01/nlp/leizhengxing/stock-rl/data/new_train_small/train.parquet
test_path=/cpfs01/nlp/leizhengxing/stock-rl/data/new_train_small/train.parquet
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    actor_rollout_ref.model.path=./data/Qwen3.5-4B  \
    ...
    +actor_rollout_ref.actor.use_igpo=True \
    ...
    ##+trainer.val_data_dir=val_log/test \
