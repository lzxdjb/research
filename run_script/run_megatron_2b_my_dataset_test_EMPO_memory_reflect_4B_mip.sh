...
# pip install transformers==5.3.0  triton==3.6.0
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    data.shuffle=False \
    +algorithm.mi_reward_coef=0.05 \
    +algorithm.mi_reward_num_negatives=60 \
    2>&1 | tee text_30.txt &



#  algorithm.mi_reward_coef=0.05 algorithm.mi_reward_num_negatives=3 algorithm.mi_reward_temperature=1.0 algorithm.mi_reward_ema_alpha=0.9 algorithm.mi_reward_zscore_eps=1e-3
