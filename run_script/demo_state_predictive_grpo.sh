...
JOB_NAME=${JOB_NAME:-8_state_predictive_grpo}
...
STATE_PREDICTIVE_OBJECTIVE=${STATE_PREDICTIVE_OBJECTIVE:-snr}
...
POLICY_LOSS_MODE=${POLICY_LOSS_MODE:-state_predictive_grpo}
