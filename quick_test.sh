...
train_path=/cpfs01/nlp/leizhengxing/stock-rl/data/stock_candlestick_2_parallel/train.parquet
test_path=/cpfs01/nlp/leizhengxing/stock-rl/data/stock_candlestick_2_parallel/test.parquet
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    +trainer.val_data_dir=/cpfs01/nlp/leizhengxing/stock-rl/val_log/grpo_big_learn_rate \
    trainer.nnodes=1 \
    trainer.save_freq=5 \
    trainer.test_freq=10 \
    trainer.total_epochs=15 \
    actor_rollout_ref.rollout.multi_turn.format=qwen3_coder \
    trainer.default_local_dir=/cpfs01/nlp/leizhengxing/stock-rl/checkpoint/grpo_big_learn_rate \
    actor_rollout_ref.rollout.multi_turn.tool_config_path="/cpfs01/nlp/leizhengxing/stock-rl/examples/sglang_multiturn/config/tool_config/stock_tool_config.yaml" \
