set -x
WEBSHOP_CLUSTER_0="10.248.100.65:8800:1"
...
JOB_NAME=webshop_grpo_soft_adaptive_grpo_turn_normalized
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    +trainer.val_data_dir=/cpfs01/nlp/leizhengxing/stock-rl/val_log/webshop_grpo_soft_adaptive_grpo_turn_normalized \
    trainer.nnodes=1 \
    ...
    trainer.default_local_dir=/cpfs01/nlp/leizhengxing/stock-rl/checkpoint/webshop_grpo_soft_adaptive_grpo_turn_normalized \
