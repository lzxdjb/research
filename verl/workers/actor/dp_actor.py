        ...
        for _ in range(self.config.ppo_epochs):
            for batch_idx, mini_batch in enumerate(mini_batches):
                ...
                for micro_batch in micro_batches:
                    ...
                    calculate_entropy = self.config.calculate_entropy or (entropy_coeff != 0) or needs_token_entropy
                    ...
                    extra_loss_kwargs = {}
                    if loss_mode in {"empo", "turn_level_ppo"} and "turn_index" in model_inputs:
                        extra_loss_kwargs["turn_index"] = model_inputs["turn_index"]
