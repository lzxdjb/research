...
class TradeAPI:
    ...
    FIXED_HEADERS = {
        "ukey": "abd50cc947cee6b8207d08a1548e5dd7",
    ...
    def upload_file(self, file_path: str, is_need_min: bool = False) -> dict:
        """
        ...
        endpoint = f"{self.base_url}/api/oas/v1/application/file/upload"
