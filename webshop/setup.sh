...
pip install faiss-cpu==1.7.4;  # Use pip instead of conda for faiss!
...
# FORCE DELETE OLD INDEXES BEFORE REBUILDING
rm -rf indexes indexes_100 indexes_1k indexes_100k
mkdir -p indexes
./run_indexing.sh
cd ..
