...
def load_webshop_goals(split: str = "train", num_products: int = 5000):
...
def main():
    ...
    write_outputs(train_samples, out_dir, "webshop_train")
    write_outputs(test_samples,  out_dir, "webshop_test")
