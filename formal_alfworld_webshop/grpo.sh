...
JOB_NAME=alfworld_grpo_big_learn_rate_fix_reward_32_new_server
...
export VLLM_RPC_TIMEOUT=300  # seconds, default is usually 60
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    +trainer.val_data_dir=/cpfs01/nlp/leizhengxing/stock-rl/val_log/alfworld_grpo_big_learn_rate_fix_reward_32_new_server \
    trainer.nnodes=1 \
    trainer.save_freq=5 \
    trainer.test_freq=5 \
    trainer.total_epochs=15 \
    actor_rollout_ref.rollout.multi_turn.format=qwen3_coder \
    trainer.default_local_dir=/cpfs01/nlp/leizhengxing/stock-rl/checkpoint/alfworld_grpo_big_learn_rate_fix_reward_32_new_server \
