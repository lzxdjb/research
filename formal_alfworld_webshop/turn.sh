set -x
ALFWORLD_CLUSTER_0="10.248.100.118:8701:1"
...
JOB_NAME=alfworld_grpo_per_turn_adaptive_normalized
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    +trainer.val_data_dir=/cpfs01/nlp/leizhengxing/stock-rl/val_log/alfworld_grpo_per_turn_adaptive_normalized \
    trainer.nnodes=1 \
    trainer.save_freq=5 \
    trainer.test_freq=5 \
    trainer.total_epochs=15 \
    actor_rollout_ref.rollout.multi_turn.format=qwen3_coder \
    trainer.default_local_dir=/cpfs01/nlp/leizhengxing/stock-rl/checkpoint/alfworld_grpo_per_turn_adaptive_normalized \
    actor_rollout_ref.actor.policy_loss.loss_mode=grpo_per_turn_adaptive_normalized \
