set -x
ALFWORLD_CLUSTER_0="10.248.100.140:8700:1"
...
JOB_NAME=alfworld_test_no_leak
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    +trainer.val_data_dir=/cpfs01/nlp/leizhengxing/stock-rl/val_log/alfworld_test_no_leak \
    trainer.nnodes=1 \
    trainer.save_freq=5 \
    trainer.test_freq=5 \
    trainer.total_epochs=15 \
    actor_rollout_ref.rollout.multi_turn.format=qwen3_coder \
    trainer.default_local_dir=/cpfs01/nlp/leizhengxing/stock-rl/checkpoint/alfworld_test_no_leak \
